...
if NOT DEFINED ODBCABSTRACTION_REPO SET ODBCABSTRACTION_REPO="https://github.com/iomete/flightsql-odbc.git"
if NOT DEFINED ODBCABSTRACTION_GIT_TAG SET ODBCABSTRACTION_GIT_TAG="33ae70b6169920800938090bb87c6683bd53e053"
